...
class TestEX1(unittest.TestCase):
    ...
    def test_max_3(self):
        ...
        self.assertEqual(EX1.max_3([]), [])
        self.assertEqual(EX1.max_3([1,2]), [])
    ...
    def test_min_n(self):
        ...
        self.assertEqual(EX1.min_n([], 4), [])
        self.assertEqual(EX1.min_n([1], 0), [])
        self.assertEqual(EX1.min_n([1], 2), [])
    ...
    def test_is_prime(self):
        ...
        self.assertEqual(EX1.is_prime(6), False)
        self.assertEqual(EX1.is_prime(7), True)
        self.assertEqual(EX1.is_prime(8), False)
        self.assertEqual(EX1.is_prime(9), False)
        self.assertEqual(EX1.is_prime(10), False)
        self.assertEqual(EX1.is_prime(11), True)
    ...
    def test_is_arithmetic(self):
        ...
        self.assertEqual(EX1.is_arithmetic([]), False)
    ...
    def test_is_geometric(self):
        ...
        self.assertEqual(EX1.is_geometric([]), False)
